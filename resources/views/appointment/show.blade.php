        ...
        <div class="col-lg-6 col-12 ">
                <address class="mb-0 text-sm">
                    <dl class="mb-0">
                        ...
                        <dd class="text-md mb-0">{{ !empty($appointment->payment) ? currency_format_with_sym($appointment->payment->amount) : ((module_is_active('CollaborativeServices')) && !empty($appointment->payments($appointment->id)) ? currency_format_with_sym($appointment->payments($appointment->id)->amount) : currency_format_with_sym(0)) }}</dd>
                        </div>
