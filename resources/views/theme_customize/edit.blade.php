                                ...
                                <div class="card-body p-3">
                                    <ul class="nav nav-pills flex-column gap-1">
                                        @foreach ($theme_json as $json_settings)
                                            <li class="nav-item"><a
                                                    href="{{ route('customize.edit', [$id, $json_settings['slug'], $json_settings['sections'][0]['slug']]) }}"
                                        ...
                                        @foreach ($theme_json as $json_settings)
                                            @if ($slug == $json_settings['slug'])
                                                @foreach ($json_settings['sections'] as $json_setting)
                                                    <li class="nav-item"><a
                                                            href="{{ route('customize.edit', [$id, $json_settings['slug'], $json_setting['slug']]) }}"
                        ...
                        <div class="col-xxl-8 col-lg-6 col-md-12 col-sm-12 col-12">
                            @foreach ($theme_json as $json_settings)
                                @if ($json_settings['slug'] == $slug)
                                    {{ Form::open(['route' => ['customize.update', $id], 'enctype' => 'multipart/form-data', 'id' => 'setting-form']) }}
                                    <div class="card" id="settings-card">
                                        <div class="card-header p-3">
                                            <h5>{{ $json_settings['title'] }} {{ _('Settings') }}</h5>
                                        </div>
