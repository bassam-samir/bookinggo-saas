    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $dataTable = (new EloquentDataTable($query))->addIndexColumn()
            ->addColumn('id', function (Appointment $Appointment) {
                ...
                $company_settings = $this->companySetting;
                $formattedValue = str_replace(!empty($company_settings['appointment_prefix']) ? $company_settings['appointment_prefix'] : '#APP0000', '', $keyword);
