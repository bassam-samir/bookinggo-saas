                        ...
                        if (isset($business)) {
                            ...
                            if ($business->form_type == 'form-layout') {
                                ...
                                if (module_is_active($business->layouts, $business->created_by)) {
                                    ...
                                    return view(strtolower($business->layouts) . '::form_layout.index', compact('slug', 'business', 'services', 'locations', 'staffs', 'customCss', 'customJs', 'combinedArray', 'files', 'custom_field', 'custom_fields', 'module', 'themeSetting', 'workingDays', 'testimonials', 'blogs', 'businesholiday', 'appointment_number', 'pixelScript', 'company_settings','bookingModes'));
                                } else {
        ...
        if (Auth::check()) {
            if (Auth::user()->type == 'super admin') {
                ...
                if (!empty($staffOption)) {
                    ...
                    $compact = ['total_business', 'total_service', 'total_appointment', 'total_staff', 'latest_services', 'latest_appointments', 'business', 'chartData', 'total_location', 'total_appointment_payment', 'staffs', 'statuses', 'staffStatusAppointments', 'totalAppointments', 'totalRevenue', 'getCompanySettings', 'getCurrencyFormatSymbol', 'latest_businesses'];
                }
